 ...
 * <h1>계좌를 해지하는 클래스</h1>
 * <p>
 * 사용자가 보유한 계좌를 해지하는 기능을 담당하는 클래스입니다.
 * 이 클래스는 로그인된 사용자의 계좌 목록을 출력하고, 사용자가 선택한 계좌의 해지 여부를 확인합니다.
 * 계좌 해지 전에 잔액이 0이 아닌 경우 송금 처리가 필요하며, 송금 후 잔액이 0이면 계좌 해지를 진행합니다.
 * </p>
 * 
 * <p>
 * 주요 기능:
 * - 로그인된 사용자 번호에 해당하는 계좌 목록을 조회합니다.
 * - 사용자가 계좌를 선택하여 해지할 수 있도록 합니다.
 * - 계좌 해지 전 잔액을 확인하고, 잔액이 남아 있을 경우 송금을 처리합니다.
 * - 계좌 해지 시, 계좌와 관련된 모든 데이터를 삭제하고 저장합니다.
 * </p>
 */
...
public class AccountDelete {
	...
	/**
	 * 계좌 해지 메뉴를 처리하는 메서드입니다.
	 * <p>
	 * 사용자가 로그인된 상태에서, 계좌 목록을 조회하고, 해지할 계좌를 선택한 후,
	 * 해당 계좌의 잔액을 확인하여 잔액이 0일 경우 계좌를 해지할 것인지 묻습니다.
	 * 잔액이 남아있으면 송금 처리를 먼저 진행한 후 계좌 해지를 진행합니다.
	 * </p>
	 */
